...
df_day = pd.read_csv("C:/Users/asus/Downloads/Tugas Bangkit/data/data 2_hour.csv")
df_hour = pd.read_csv("C:/Users/asus/Downloads/Tugas Bangkit/data/data1_day.csv")
#######################
# Page configuration
st.set_page_config(
